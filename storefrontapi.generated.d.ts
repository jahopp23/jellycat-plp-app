...
export type MenCollectionProductsQueryVariables = StorefrontAPI.Exact<{
  after?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['String']>;
  collectionHandle: StorefrontAPI.Scalars['String'];
  first: StorefrontAPI.Scalars['Int'];
  previewVariants: StorefrontAPI.Scalars['Int'];
}>;

export type MenCollectionProductsQuery = {
...
export type MenPlpProductVariantsQueryVariables = StorefrontAPI.Exact<{
  after?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['String']>;
  first: StorefrontAPI.Scalars['Int'];
  handle: StorefrontAPI.Scalars['String'];
}>;

export type MenPlpProductVariantsQuery = {
...
interface GeneratedQueryTypes {
  '#graphql\n  query MenCollectionProducts(\n    $after: String\n    $collectionHandle: String!\n    $first: Int!\n    $previewVariants: Int!\n  ) {\n    collection(handle: $collectionHandle) {\n      id\n      handle\n      title\n      products(first: $first, after: $after) {\n        nodes {\n          id\n          title\n          handle\n          availableForSale\n          featuredImage {\n            url\n            altText\n            width\n            height\n          }\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n            maxVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          options {\n            name\n            values\n          }\n          variants(first: $previewVariants) {\n            nodes {\n              id\n              title\n              availableForSale\n              selectedOptions {\n                name\n                value\n              }\n              price {\n                amount\n                currencyCode\n              }\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n            pageInfo {\n              hasNextPage\n              endCursor\n            }\n          }\n        }\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n      }\n    }\n  }\n': {
    return: MenCollectionProductsQuery;
    variables: MenCollectionProductsQueryVariables;
  };
  '#graphql\n  query MenPlpProductVariants($after: String, $first: Int!, $handle: String!) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      availableForSale\n      featuredImage {\n        url\n        altText\n        width\n        height\n      }\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n        maxVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      options {\n        name\n        values\n      }\n      variants(first: $first, after: $after) {\n        nodes {\n          id\n          title\n          availableForSale\n          selectedOptions {\n            name\n            value\n          }\n          price {\n            amount\n            currencyCode\n          }\n          image {\n            url\n            altText\n            width\n            height\n          }\n        }\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n      }\n    }\n  }\n': {
    return: MenPlpProductVariantsQuery;
    variables: MenPlpProductVariantsQueryVariables;
  };
